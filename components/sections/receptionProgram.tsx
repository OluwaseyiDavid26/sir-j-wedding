...
const receptionProgram = [
  ...
  },
  {
    time: "",
    title: "Welcome",
    description: "Official welcome address to all guests",
    category: "program",
  },
  {
    time: "",
  ...
  {
    time: "",
    title: "Parents' Entrance",
    description: "Grand entrance of both families",
    category: "entrance",
  },
  {
    time: "",
    title: "Couple's Entrance",
    description: "Grand entrance of Mr & Mrs",
    category: "entrance",
  },
  {
    time: "",
    title: "Opening Remark",
    description: "Words from the MC and officiating team",
    category: "program",
  },
  {
    time: "",
  ...
  },
  {
    time: "",
    title: "Games",
    description: "Fun and interactive games for the couple and guests",
    category: "highlight",
  },
  {
    time: "",
    title: "Official Close",
    description: "Formal close of the programme",
    category: "program",
  },
  {
    time: "",
    title: "Meet & Greet",
    description: "Guests mingle and celebrate with the couple",
    category: "dining",
  },
  {
    time: "",
    title: "Games & Dance",
    description: "More dancing, fun and celebration on the floor",
    category: "highlight",
  },
  {
    time: "",
    title: "Vote of Thanks",
    description: "Appreciation to all guests and family",
    category: "program",
  },
  {
    time: "",
    title: "Final Close",
    description: "Benediction and farewell to all guests",
    category: "departure",
  },
];
...
function ReceptionItem({
  ...
  return (
    ...
    >
      {/* Left side */}
      <div className={`pb-8 ${isLeft ? "pr-6 md:pr-10 text-right" : ""}`}>
        {isLeft && <ReceptionCard item={item} align="right" index={index} />}
        {!isLeft && (
          <div
            className="font-jost text-[0.6rem] tracking-[0.3em] uppercase pt-2 text-right"
            style={{ color: "rgba(212,175,55,0.4)" }}
      ...
      {/* Right side */}
      <div className={`pb-8 ${!isLeft ? "pl-6 md:pl-10" : ""}`}>
        {!isLeft && <ReceptionCard item={item} align="left" index={index} />}
        {isLeft && (
          <div
            className="font-jost text-[0.6rem] tracking-[0.3em] uppercase pt-2"
            style={{ color: "rgba(212,175,55,0.4)" }}
