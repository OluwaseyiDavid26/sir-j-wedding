  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(to bottom, #080310 0%, #0a0514 60%, #050208 100%)",
        }}
      >
        {/* Ambient glows */}
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse, rgba(107,63,160,0.12) 0%, transparent 70%)",
          }}
        />
        <div
        ...
        <div className="max-w-3xl mx-auto relative z-10">
          ...
          >
            ...
            <p
              className="font-cormorant italic text-white/40 mt-4 leading-relaxed max-w-md"
              style={{ fontSize: "clamp(1rem, 2vw, 1.2rem)" }}
            >
              If you need any assistance, kindly reach out. We would love to
          ...
          >
            {contacts.map((contact, i) => (
              ...
              >
                ...
                {/* Name */}
                <p
                  className="font-jost text-[0.6rem] tracking-[0.35em] uppercase mb-1"
                  style={{ color: "rgba(255,255,255,0.3)" }}
                >
                  Contact
                </p>
                <h3
                  className="font-cormorant italic text-white font-light mb-4"
                ...
                {/* Phone number */}
                <p
                  className="font-jost font-light tracking-[0.15em] mb-6"
                  style={{
          ...
          >
            ...
            <p
              className="font-jost text-[0.6rem] tracking-[0.4em] uppercase mb-4"
            ...
            <h3
              className="font-cormorant italic font-light text-white mb-2"
            ...
            <p
              className="font-jost text-[0.65rem] tracking-[0.15em] leading-loose"
              style={{ color: "rgba(255,255,255,0.3)" }}
            >
            ...
            <p
              className="font-jost text-[0.65rem] tracking-[0.25em] uppercase"
