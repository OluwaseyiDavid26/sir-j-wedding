...
//           >
//             <span
//               className={`font-cormorant italic font-semibold text-2xl tracking-wide transition-colors duration-500
...
//             </span>
//             <span
//               className={`font-jost text-[0.6rem] font-medium tracking-[0.22em] uppercase mt-0.5 transition-colors duration-500
...
//                   {l.label}
//                   <span
//                     className={`absolute bottom-1 left-1/2 -translate-x-1/2 w-0 h-px
      ...
      >
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between h-20">
          ...
          >
            ...
            >
              Oluwatosin{" "}
              <span className="text-yellow-500 not-italic font-bold">
                &amp;
              </span>{" "}
              Jesutomi
            </span>
